    ...
    <div class="resume-item-inner">
      <div class="resume-item-title">
        <div class="left">
          ...
          <div
            v-if="globalData.usingMouse && !globalData.usingTouch"
            id="drag-me"
          >
            拖拽此处排序<i class="ri-draggable"></i>
          </div>
        </div>
        <div class="buttons-container right">
          <div class="buttons-container">
            ...
            >
              ...
              <span :style="{ whiteSpace: 'nowrap' }">上移</span>
            </button>
          </div>
          <div class="buttons-container">
            <button
            ...
            >
              ...
              <span :style="{ whiteSpace: 'nowrap' }">下移</span>
            </button>
          </div>
          <button
            class="button"
      ...
      <div class="form-line">
        ...
        <select v-model="localData.item.type">
          <option
      ...
      <div v-if="data.item.type == 'img'">
        <div class="form-line">
          ...
          <textarea rows="1" v-model="localData.item.data.alt"></textarea>
        </div>
        <div class="form-line">
          <div class="form-title">资源地址</div>
          <textarea rows="3" v-model="localData.item.data.src"></textarea>
        </div>
      </div>
      ...
      <div v-else>
        <div class="form-line">
          ...
          <textarea rows="6" v-model="localData.item.data.content"></textarea>
        </div>
      </div>
    </div>
  </div>
